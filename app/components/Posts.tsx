    ...
    return (
        <div className="flex flex-col gap-7 p-2 lg:p-0 max-w-screen-md w-full items-center justify-center">
            ...
            <article className="flex flex-col w-full items-center justify-center">
                {posts.map((post, i) => (
                    <div className="flex w-full py-4 p-1 lg:p-1 rounded-lg bg-[#1B2730] gap-2 lg:gap-6 flex-row mb-5" key={i}>
                        ...
                        <div className="flex gap-2 lg:gap-3 flex-col w-[80%] justify-center ">
                            ...
                            <div className=" w-full flex justify-center items-center">
                                {post.image && <img className="w-[30rem] rounded-md h-[30rem] object-cover" src={post.image} alt="Imagen de un post" />}
                            </div>

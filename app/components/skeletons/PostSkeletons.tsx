    ...
    return (
        ...
        <SkeletonTheme baseColor="#1f2a37" highlightColor="#374151">
            <div className="flex  flex-col gap-7 max-w-screen-md w-full items-center justify-center">
                {/* Skeleton para la creación de un post */}
